...
local function dotnet_build()
	vim.cmd("FloatermNew dotnet build -f net10.0-android -p:Configuration=Debug " .. adb_flag())
...
local function dotnet_run()
	vim.cmd("FloatermNew dotnet build -t:Run -f net10.0-android -p:Configuration=Debug"
...
local function dotnet_clean()
	vim.cmd("FloatermNew dotnet clean -f net10.0-android -p:Configuration=Debug " .. adb_flag())
	vim.schedule(function()
		vim.api.nvim_feedkeys(
			vim.api.nvim_replace_termcodes("<C-\\><C-n>", true, true, true),
			"n",
